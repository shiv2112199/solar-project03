    ...
    <section className="bg-light">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <div className="px-6 py-12 lg:py-16">
          <p className="font-bold text-yellow-400">Free Quote</p>
          ...
          <form className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <select className="h-[55px] rounded-md bg-white px-4 outline-none focus:ring-2 focus:ring-primary/30">
              <option className='bg-yellow-300'>Select A Service</option>
            ...
            <button className="rounded-full bg-yellow-400 px-8 py-3 font-medium text-white hover:opacity-90 sm:col-span-2 w-fit">
              Submit
            </button>
          </form>
        </div>
