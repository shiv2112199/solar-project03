    ...
    <section className="bg-light my-12">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <div className="px-6 py-12 lg:py-16">
          <p className="font-bold text-2xl text-yellow-400">About Us</p>
          ...
          <div className="flex flex-col gap-2 my-5">
            <div className="inline-flex items-center gap-2 text-xl font-semibold px-3 py-1 rounded-full ">
              <ShieldCheck  className="text-yellow-500" size={40} /> Government subsidy assistance
            </div>

            <div className="inline-flex items-center gap-2 text-xl font-semibold px-3 py-1 rounded-full ">
              <Calendar className="text-yellow-500"  size={40} /> 25-year panel warranty
            </div>

            <div className="inline-flex items-center gap-2 text-xl font-semibold px-3 py-1 rounded-full ">
              <UserCheck className="text-yellow-500"  size={40}/> Local installation team
            </div>
          </div>
